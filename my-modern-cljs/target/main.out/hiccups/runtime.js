...
var _STAR_html_mode_STAR_7015 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_7015;
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__7016){
var vec__7018 = p__7016;
var name = cljs.core.nth.call(null,vec__7018,(0),null);
var value = cljs.core.nth.call(null,vec__7018,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null))){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__7019){
var vec__7022 = p__7019;
var tag = cljs.core.nth.call(null,vec__7022,(0),null);
var content = cljs.core.nthnext.call(null,vec__7022,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__7023 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__7023,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__7023,(1),null);
var id = cljs.core.nth.call(null,vec__7023,(2),null);
var class$ = cljs.core.nth.call(null,vec__7023,(3),null);
...
var vec__7025 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__7025,(0),null);
var attrs = cljs.core.nth.call(null,vec__7025,(1),null);
var content = cljs.core.nth.call(null,vec__7025,(2),null);
if(cljs.core.truth_((function (){var or__4989__auto__ = content;
