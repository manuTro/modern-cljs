...
var len__6046__auto___8514 = arguments.length;
var i__6047__auto___8515 = (0);
while(true){
if((i__6047__auto___8515 < len__6046__auto___8514)){
args__6053__auto__.push((arguments[i__6047__auto___8515]));

var G__8516 = (i__6047__auto___8515 + (1));
i__6047__auto___8515 = G__8516;
continue;
} else {
}
break;
...
});})(map__8512,map__8512__$1,on_success,on_error))
:null),new cljs.core.Keyword(null,"on-error","on-error",1728533530),(cljs.core.truth_(on_error)?((function (map__8512,map__8512__$1,on_success,on_error){
return (function (data){
var data__$1 = ((cljs.core._EQ_.call(null,data,""))?"nil":data);
...
shoreleave.remotes.http_rpc.remote_callback.cljs$lang$applyTo = (function (seq8508){
...
var G__8511 = cljs.core.first.call(null,seq8508__$2);
var seq8508__$3 = cljs.core.next.call(null,seq8508__$2);
return shoreleave.remotes.http_rpc.remote_callback.cljs$core$IFn$_invoke$arity$variadic(G__8509,G__8510,G__8511,seq8508__$3);
});
