...
adzerk.boot_reload.client.handle = (function (){var method_table__5902__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"adzerk.boot-reload.client","handle"),((function (method_table__5902__auto__,prefer_table__5903__auto__,method_cache__5904__auto__,cached_hierarchy__5905__auto__,hierarchy__5906__auto__){
...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__6499,opts){
var map__6500 = p__6499;
var map__6500__$1 = ((((!((map__6500 == null)))?((((map__6500.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6500.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6500):map__6500);
var files = cljs.core.get.call(null,map__6500__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6047__auto___6506 = arguments.length;
var i__6048__auto___6507 = (0);
while(true){
if((i__6048__auto___6507 < len__6047__auto___6506)){
args__6054__auto__.push((arguments[i__6048__auto___6507]));

var G__6508 = (i__6048__auto___6507 + (1));
i__6048__auto___6507 = G__6508;
continue;
} else {
}
break;
...
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__6055__auto__);
});

adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__6504){
var vec__6505 = p__6504;
var opts = cljs.core.nth.call(null,vec__6505,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__6505,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__6505,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__6505,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__6505,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq6502){
var G__6503 = cljs.core.first.call(null,seq6502);
var seq6502__$1 = cljs.core.next.call(null,seq6502);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__6503,seq6502__$1);
});
