...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__8432,opts){
var map__8433 = p__8432;
var map__8433__$1 = ((((!((map__8433 == null)))?((((map__8433.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8433.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8433):map__8433);
var files = cljs.core.get.call(null,map__8433__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6047__auto___8439 = arguments.length;
var i__6048__auto___8440 = (0);
while(true){
if((i__6048__auto___8440 < len__6047__auto___8439)){
args__6054__auto__.push((arguments[i__6048__auto___8440]));

var G__8441 = (i__6048__auto___8440 + (1));
i__6048__auto___8440 = G__8441;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__8437){
var vec__8438 = p__8437;
var opts = cljs.core.nth.call(null,vec__8438,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__8438,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__8438,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__8438,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__8438,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq8435){
var G__8436 = cljs.core.first.call(null,seq8435);
var seq8435__$1 = cljs.core.next.call(null,seq8435);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__8436,seq8435__$1);
});
