...
var repl_conn_9743 = "ws://localhost:44345";
if(cljs.core.truth_((function (){var and__4977__auto__ = repl_conn_9743;
...
weasel.repl.connect.call(null,"ws://localhost:44345");
} else {
}
