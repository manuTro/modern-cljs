...
var repl_conn_10414 = "ws://localhost:44755";
if(cljs.core.truth_((function (){var and__4977__auto__ = repl_conn_10414;
...
weasel.repl.connect.call(null,"ws://localhost:44755");
} else {
}
