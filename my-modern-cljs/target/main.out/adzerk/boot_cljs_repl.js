...
var repl_conn_8964 = "ws://localhost:35475";
if(cljs.core.truth_((function (){var and__4976__auto__ = repl_conn_8964;
...
weasel.repl.connect.call(null,"ws://localhost:35475");
} else {
}
