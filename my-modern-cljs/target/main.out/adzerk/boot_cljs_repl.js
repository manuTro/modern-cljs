...
var repl_conn_8966 = "ws://localhost:44911";
if(cljs.core.truth_((function (){var and__4976__auto__ = repl_conn_8966;
...
weasel.repl.connect.call(null,"ws://localhost:44911");
} else {
}
