...
return shoreleave.remotes.http_rpc.remote_callback.call(null,new cljs.core.Keyword(null,"email-domain-errors","email-domain-errors",-581599182),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [email], null),(function (p1__8035_SHARP_){
if(cljs.core.truth_(p1__8035_SHARP_)){
...
domina.core.prepend_BANG_.call(null,domina.core.by_id.call(null,"loginForm"),[cljs.core.str((function (){var attrs8041 = cljs.core.first.call(null,errors);
if(cljs.core.map_QMARK_.call(null,attrs8041)){
return [cljs.core.str("<div"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),null,new cljs.core.Keyword(null,"class","class",-2030961996),"help email"], null),attrs8041))),cljs.core.str(">"),cljs.core.str("</div>")].join('');
} else {
return [cljs.core.str("<div class=\"help email\">"),cljs.core.str(hiccups.runtime.render_html.call(null,attrs8041)),cljs.core.str("</div>")].join('');
}
})())].join(''));
...
if(cljs.core.truth_(temp__4423__auto__)){
var errors = temp__4423__auto__;
domina.core.append_BANG_.call(null,domina.core.by_id.call(null,"loginForm"),[cljs.core.str((function (){var attrs8043 = cljs.core.first.call(null,errors);
if(cljs.core.map_QMARK_.call(null,attrs8043)){
return [cljs.core.str("<div"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),null,new cljs.core.Keyword(null,"class","class",-2030961996),"help password"], null),attrs8043))),cljs.core.str(">"),cljs.core.str("</div>")].join('');
} else {
return [cljs.core.str("<div class=\"help password\">"),cljs.core.str(hiccups.runtime.render_html.call(null,attrs8043)),cljs.core.str("</div>")].join('');
}
})())].join(''));
...
if(cljs.core.truth_(temp__4423__auto__)){
var map__8048 = temp__4423__auto__;
...
var e_errs = cljs.core.get.call(null,map__8048__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var p_errs = cljs.core.get.call(null,map__8048__$1,new cljs.core.Keyword(null,"password","password",417022471));
