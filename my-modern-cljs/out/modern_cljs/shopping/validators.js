...
modern_cljs.shopping.validators.validate_shopping_quantity = (function modern_cljs$shopping$validators$validate_shopping_quantity(quantity){
return cljs.core.first.call(null,new cljs.core.Keyword(null,"quantity","quantity",-1929050694).cljs$core$IFn$_invoke$arity$1(modern_cljs.shopping.validators.validate_shopping_form.call(null,quantity,"0","0","0")));
});
modern_cljs.shopping.validators.validate_shopping_price = (function modern_cljs$shopping$validators$validate_shopping_price(price){
return modern_cljs.shopping.validators.validate_shopping_form.call(null,"1",price,"0","0");
});
modern_cljs.shopping.validators.validate_shopping_tax = (function modern_cljs$shopping$validators$validate_shopping_tax(tax){
return modern_cljs.shopping.validators.validate_shopping_form.call(null,"1","0",tax,"0");
});
modern_cljs.shopping.validators.validate_shopping_discount = (function modern_cljs$shopping$validators$validate_shopping_discount(discount){
return modern_cljs.shopping.validators.validate_shopping_form.call(null,"1","0","0",discount);
});
