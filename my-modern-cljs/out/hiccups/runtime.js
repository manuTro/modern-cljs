...
var _STAR_html_mode_STAR_8542 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_8542;
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__8543){
var vec__8545 = p__8543;
var name = cljs.core.nth.call(null,vec__8545,(0),null);
var value = cljs.core.nth.call(null,vec__8545,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null))){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__8546){
var vec__8549 = p__8546;
var tag = cljs.core.nth.call(null,vec__8549,(0),null);
var content = cljs.core.nthnext.call(null,vec__8549,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__8550 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__8550,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__8550,(1),null);
var id = cljs.core.nth.call(null,vec__8550,(2),null);
var class$ = cljs.core.nth.call(null,vec__8550,(3),null);
...
var vec__8552 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__8552,(0),null);
var attrs = cljs.core.nth.call(null,vec__8552,(1),null);
var content = cljs.core.nth.call(null,vec__8552,(2),null);
if(cljs.core.truth_((function (){var or__7411__auto__ = content;
