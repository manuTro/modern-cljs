...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8405__auto__,writer__8406__auto__,opt__8407__auto__){
return cljs.core._write.call(null,writer__8406__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__9475 = o;
(G__9475[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__9477__i < G__9477__a.length) {G__9477__a[G__9477__i] = arguments[G__9477__i + 0]; ++G__9477__i;}
  args = new cljs.core.IndexedSeq(G__9477__a,0);
} 
...
if(cljs.core.truth_((function (){var and__7795__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__7795__auto__){
var and__7795__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__7795__auto____$1){
var and__7795__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__7795__auto____$2)){
return (jsprops["hasOwnProperty"])("value");
} else {
return and__7795__auto____$2;
}
} else {
return and__7795__auto____$1;
}
} else {
...
var G__9483 = jsprops;
(G__9483["defaultValue"] = value);

(G__9483["onChange"] = ((function (G__9483,v,value,on_change){
return (function (p1__9481_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9481_SHARP_);
});})(G__9483,v,value,on_change))
);
...
var vec__9488 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__9488,(0),null);
var id = cljs.core.nth.call(null,vec__9488,(1),null);
var class$ = cljs.core.nth.call(null,vec__9488,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___9491 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___9491 == null)){
} else {
var key_9492 = temp__4429__auto___9491;
(jsprops["key"] = key_9492);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__9494 = (new reagent.impl.template.NativeWrapper());
(G__9494["name"] = c);
...
var len__8865__auto___9500 = arguments.length;
var i__8866__auto___9501 = (0);
while(true){
if((i__8866__auto___9501 < len__8865__auto___9500)){
args__8872__auto__.push((arguments[i__8866__auto___9501]));

var G__9502 = (i__8866__auto___9501 + (1));
i__8866__auto___9501 = G__9502;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8873__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq9498){
var G__9499 = cljs.core.first.call(null,seq9498);
var seq9498__$1 = cljs.core.next.call(null,seq9498);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__9499,seq9498__$1);
});
...
break;
default:
var G__9506 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__9506;
continue;
...
var n__8710__auto___9509 = a.length;
var i_9510 = (0);
while(true){
if((i_9510 < n__8710__auto___9509)){
(a[i_9510] = reagent.impl.template.as_element.call(null,(a[i_9510])));
...
var a = cljs.core.into_array.call(null,s);
var n__8710__auto___9512 = a.length;
var i_9513 = (0);
while(true){
if((i_9513 < n__8710__auto___9512)){
var val_9514 = (a[i_9513]);
if((cljs.core.vector_QMARK_.call(null,val_9514)) && ((reagent.impl.template.key_from_vec.call(null,val_9514) == null))){
(o["no-key"] = true);
} else {
}

(a[i_9513] = reagent.impl.template.as_element.call(null,val_9514));

var G__9515 = (i_9513 + (1));
i_9513 = G__9515;
continue;
} else {
}
...
var ctx = {};
var vec__9517 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__9517,(0),null);
var derefed = cljs.core.nth.call(null,vec__9517,(1),null);
...
var G__9519 = (cljs.core.count.call(null,argv) - first_child);
switch (G__9519) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__9519){
